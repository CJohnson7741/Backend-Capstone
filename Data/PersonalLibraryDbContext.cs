...
protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    ...
    modelBuilder
        ...
        modelBuilder
            .Entity<Book>()
            .HasData(
                new Book { Id = 1, Title = "Foundation", ISBN = "978-0-553-80371-0", GenreId = 1, UserProfileId = 1 },
                new Book { Id = 2, Title = "Harry Potter and the Sorcerer's Stone", ISBN = "978-0-590-35340-3", GenreId = 2, UserProfileId = 1 },
                new Book { Id = 3, Title = "Murder on the Orient Express", ISBN = "978-0-06-269366-2", GenreId = 3, UserProfileId = 1 },
                new Book { Id = 4, Title = "The Hobbit", ISBN = "978-0-618-00221-3", GenreId = 2, UserProfileId = 2 } // Adding a book for the second user
            );
